...
const api=createBookingApi({dataDir:process.env.ORGANZZA_DATA_DIR||path.join(root,'data'),password:process.env.ADMIN_PASSWORD||'',sessionSecret:process.env.SESSION_SECRET||'',databaseUrl:process.env.DATABASE_URL||'',vercel});
